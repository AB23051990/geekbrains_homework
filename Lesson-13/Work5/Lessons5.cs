...
namespace Work5
{
    ...
    {        
        ...
        {
            Console.WriteLine($"\nЗадание № 1:");
            Console.WriteLine($"Реализуйте методы поиска в дереве 'поиск в ширину' и 'поиск в глубину' (класс дерева должен быть реализован в ДЗ урока 4) с выводом каждого шага в консоль.");
