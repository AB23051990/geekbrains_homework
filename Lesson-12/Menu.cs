        ...
        static void Main(string[] args)
        {
            while (true) //запуск цикла программы
            {
                ...
                {   //выводит на консоль основное меню практических заданий
                    ...
                    if (menu == 3)//выводит на консоль практическую работу № 3 ссылаясь на класс 
                    {
                        ...
                        if (menu3 == 1)//команда выводит на консоль задание № 3 ссылаясь на класс (PointClassDouble)
                        {
                            var les3 = new Point();
                            les3.PointW();
                            Console.WriteLine(les3);
                        }
                        if (menu3 > 1)
                        { Console.WriteLine("нет такого задания"); }
                    }
                ...
                catch (Exception ex)  //выводит на консоль ошибоку
                {
                    Console.WriteLine("Ошибка: выберите цыфру" + ex.Message);
                }
                finally { }
            }
        }
